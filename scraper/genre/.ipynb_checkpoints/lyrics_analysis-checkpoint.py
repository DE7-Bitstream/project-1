...
# 설정 (경로 수정)
INPUT_CSV = os.path.join(os.path.dirname(__file__), "csv", "melon_genre_steady_songs_with_lyrics.csv")
OUT_CSV = os.path.join(os.path.dirname(__file__), "csv", "melon_song_words.csv")
